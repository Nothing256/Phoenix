...
def main():
    parser = argparse.ArgumentParser(description="Agent 3: Blind Formal Judge (Ablation)")
    parser.add_argument("--model_path", type=str, required=True, help="Path to the LLM")
    parser.add_argument("--input_file", type=str, required=True, help="Path to Agent 1 Sliced output JSONL")
    parser.add_argument("--output_file", type=str, required=True, help="Path to save Agent 3 Blind evaluation JSONL")
    ...
    print(f"Executing BLIND Judge on {len(prompts)} independent samples...")
    ...
    print("\n--- ZERO-SHOT BLIND AGENT 3 METRICS ---")
